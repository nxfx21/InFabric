...
public class ConfigAndManagerTest {
    ...
    public void testHitTrackerScheduler() {
        var tracker = com.catadmirer.infuseSMP.Infuse.getInstance().getHitTracker();
    ...
    public void testDataManagerSlotMapping() {
        var dataManager = com.catadmirer.infuseSMP.Infuse.getInstance().getDataManager();
    ...
    public void testUninfuseCommandRegistration() {
        var commandManager = new com.catadmirer.infuseSMP.commands.InfuseCommandManager();
        ...
        try {
            var method = com.catadmirer.infuseSMP.commands.InfuseCommandManager.class.getDeclaredMethod("registerUninfuseCommand", com.mojang.brigadier.CommandDispatcher.class);
