package com.catadmirer.infuseSMP.tier2_boundary;
...
public class BoundaryCasesTest {
    ...
    public void testInvalidRegistrationId() {
        InfuseEffect dummyInvalid = new InfuseEffect("invalid", 101, false, java.awt.Color.BLACK, net.minecraft.entity.boss.BossBar.Color.WHITE) {
            ...
            @Override public com.catadmirer.infuseSMP.Message getName() { return null; }
            @Override public com.catadmirer.infuseSMP.Message getLore() { return null; }
        };
    ...
    public void testStrengthHpBoundaries() {
        net.minecraft.server.network.ServerPlayerEntity player = org.mockito.Mockito.mock(net.minecraft.server.network.ServerPlayerEntity.class);
